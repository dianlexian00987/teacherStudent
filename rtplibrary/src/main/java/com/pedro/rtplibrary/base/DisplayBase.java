...
public abstract class DisplayBase implements GetAacData, GetVideoData, GetMicrophoneData {
  ...
  public boolean prepareVideo(int width, int height, int fps, int bitrate, int rotation, int dpi) {
    return prepareVideo(width, height, fps, bitrate, rotation, dpi, -1, -1, 5);
  }
  ...
  public boolean prepareVideo() {
    //return prepareVideo(960, 540, 20, 3000 * 1024, 0, 320);
    return prepareVideo(960, 540, 20, 3000 * 1024, 0, 320);
  }

  /**
   * Same to call:
   * prepareAudio(64 * 1024, 32000, true, false, false);32000
   *
   * @return true if success, false if you get a error (Normally because the encoder selected
   * doesn't support any configuration seated or your device hasn't a AAC encoder).
   */
  public boolean prepareAudio() {
    return prepareAudio(200 * 1024, 32000, true, false, false);
  }
