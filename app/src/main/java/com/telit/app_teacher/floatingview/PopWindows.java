...
public class PopWindows<X extends PopWindows> {
     ...
     * 创建一个局部悬浮窗
     */
    public PopWindows(Activity activity) {
     ...
     * 创建一个全局悬浮窗
     */
    public PopWindows(Application application) {
    ...
    private PopWindows(Context context) {
        mContext = context;
