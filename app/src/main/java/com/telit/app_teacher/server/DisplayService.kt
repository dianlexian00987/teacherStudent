...
import com.telit.app_teacher.activity.SplishActivity
  ...
  companion object {
    ...
    private val connectCheckerRtp = object : ConnectCheckerRtp {
      override fun onConnectionSuccessRtp() {
        ...
        //推流成功发送消息
        SimpleClientNetty.getInstance().sendMsgToServer(MsgUtils.HEAD_Screen_Cast,
                MsgUtils.teacherAddress(Constant.RtmpUrl))
