...
public class FloatingView extends RelativeLayout implements View.OnClickListener {
    ...
    private TextView tv_start_suo_ping;
    ...
    public FloatingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mGif_float.play();
        //锁屏
        tv_start_suo_ping = (TextView) findViewById(R.id.tv_start_suo_ping);
        tv_start_suo_ping.setOnClickListener(this);
...
//      mFloatBallParams.type = WindowManager.LayoutParams.TYPE_SYSTEM_ALERT;
    ...
    public void onClick(View v) {
        ...
        if ( id== R.id.tv_start_suo_ping) {
         ...
         /*   if (isOnLion.equals("onLine")){
                ...
                //推流成功发送消息
                SimpleClientNetty.getInstance().sendMsgToServer(MsgUtils.HEAD_Screen_Cast, MsgUtils.teacherAddress(SplishActivity.rtmpUrl));
            }else {
    ...
    public void setIsOnLine(String isOnLion) {
